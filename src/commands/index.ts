...
const commandClasses: CommandClass[] = [ExploreCommand, CleanCommand, ResearchCommand, PlanCommand, PlanSaveCommand, PlanLoadCommand, NavigateCommand, KnowCommand, AriaCommand, HtmlCommand, DataCommand, TestCommand, ExitCommand];
