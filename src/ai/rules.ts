...
export const unexpectedPopupRule = dedent`
  ...
  If buttons are disabled unexpectedly, read disabledReason in the click result first — it is what the app shows on hover. Only when empty, check for a blocking popup or empty required fields.
